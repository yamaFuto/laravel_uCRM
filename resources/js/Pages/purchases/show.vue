                                    ...
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <div for="date" class="leading-7 text-sm text-gray-600">日付</div>
                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">商品名</font>
                                                </font>
                                            </th>
                                            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">金額</font>
                                                </font>
                                            </th>
                                            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                                                <font style="vertical-align: inherit;">
                                    ...
                                    <tbody>
                                        <tr v-for="item in props.items" :key="item.id">
                                            <td class="px-4 py-3">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">{{item.item_id}}</font>
                                                </font>
                                            </td>
                                            <td class="px-4 py-3">
                                                <font style="vertical-align: inherit;">
                                            ...
                                            <td class="px-4 py-3">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">{{item.item_price}}</font>
                                                </font>
                                            </td>
                                            ...
                                            <td class="px-4 py-3">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">{{ item.subtotal }}</font>
                                                </font>
                                            </td>
                                        </tr>
                                    </tbody>
